...
class CCustomEventListener : public ::testing::TestEventListener {
  public:
    ...
    CCustomEventListener(const CCustomEventListener &) = delete;
    CCustomEventListener &operator=(const CCustomEventListener &) = delete;
  ...
  private:
    ...
    void OnTestProgramEnd(const ::testing::UnitTest &unitTest) override {
        ...
        auto executionNameLen = strlen(executionName);
        ...
        if (hardwarePrefix != "---") {
            ...
            fprintf(
                ...
                "==  %s %ss %s   ==\n"
                "%s==================\n",
                paddingE.c_str(), hardwarePrefix.c_str(), executionName, ultStatus.c_str(), paddingE.c_str());
        } else {
            ...
            fprintf(
                ...
                "==   %ss %s   ==\n"
                "%s==================\n",
                paddingE.c_str(), executionName, ultStatus.c_str(), paddingE.c_str());
        }
