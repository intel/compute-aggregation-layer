...
inline void initOclIcdDispatchTable(cl_icd_dispatch &dt){
    dt.clGetPlatformIDs = Cal::Icd::Ocl::clGetPlatformIDs;
    dt.clGetPlatformInfo = Cal::Icd::Ocl::clGetPlatformInfo;
    dt.clGetExtensionFunctionAddress = Cal::Icd::Ocl::clGetExtensionFunctionAddress;
    dt.clGetDeviceIDs = Cal::Icd::Ocl::clGetDeviceIDs;
    dt.clGetDeviceInfo = Cal::Icd::Ocl::clGetDeviceInfo;
    dt.clCreateContext = Cal::Icd::Ocl::clCreateContext;
    ...
    dt.clCreateCommandQueueWithProperties = Cal::Icd::Ocl::clCreateCommandQueueWithProperties;
    dt.clCreateProgramWithSource = Cal::Icd::Ocl::clCreateProgramWithSource;
    dt.clCreateProgramWithIL = Cal::Icd::Ocl::clCreateProgramWithIL;
    dt.clCreateProgramWithBinary = Cal::Icd::Ocl::clCreateProgramWithBinary;
    dt.clCreateProgramWithBuiltInKernels = Cal::Icd::Ocl::clCreateProgramWithBuiltInKernels;
    dt.clUnloadCompiler = Cal::Icd::Ocl::clUnloadCompiler;
    dt.clUnloadPlatformCompiler = Cal::Icd::Ocl::clUnloadPlatformCompiler;
    dt.clBuildProgram = Cal::Icd::Ocl::clBuildProgram;
    ...
    dt.clGetCommandQueueInfo = Cal::Icd::Ocl::clGetCommandQueueInfo;
    dt.clGetProgramInfo = Cal::Icd::Ocl::clGetProgramInfo;
    dt.clGetMemObjectInfo = Cal::Icd::Ocl::clGetMemObjectInfo;
    dt.clGetImageInfo = Cal::Icd::Ocl::clGetImageInfo;
    dt.clGetSamplerInfo = Cal::Icd::Ocl::clGetSamplerInfo;
    dt.clGetKernelInfo = Cal::Icd::Ocl::clGetKernelInfo;
    dt.clGetKernelWorkGroupInfo = Cal::Icd::Ocl::clGetKernelWorkGroupInfo;
    dt.clGetKernelArgInfo = Cal::Icd::Ocl::clGetKernelArgInfo;
    dt.clGetKernelSubGroupInfo = Cal::Icd::Ocl::clGetKernelSubGroupInfo;
    dt.clReleaseCommandQueue = Cal::Icd::Ocl::clReleaseCommandQueue;
    dt.clReleaseContext = Cal::Icd::Ocl::clReleaseContext;
    dt.clReleaseDevice = Cal::Icd::Ocl::clReleaseDevice;
    dt.clReleaseKernel = Cal::Icd::Ocl::clReleaseKernel;
    dt.clReleaseSampler = Cal::Icd::Ocl::clReleaseSampler;
    dt.clReleaseProgram = Cal::Icd::Ocl::clReleaseProgram;
    dt.clReleaseMemObject = Cal::Icd::Ocl::clReleaseMemObject;
    dt.clReleaseEvent = Cal::Icd::Ocl::clReleaseEvent;
    dt.clRetainCommandQueue = Cal::Icd::Ocl::clRetainCommandQueue;
    dt.clRetainContext = Cal::Icd::Ocl::clRetainContext;
    dt.clRetainDevice = Cal::Icd::Ocl::clRetainDevice;
    dt.clRetainProgram = Cal::Icd::Ocl::clRetainProgram;
    dt.clRetainMemObject = Cal::Icd::Ocl::clRetainMemObject;
    dt.clRetainSampler = Cal::Icd::Ocl::clRetainSampler;
    dt.clRetainKernel = Cal::Icd::Ocl::clRetainKernel;
    dt.clRetainEvent = Cal::Icd::Ocl::clRetainEvent;
    dt.clFlush = Cal::Icd::Ocl::clFlush;
    dt.clFinish = Cal::Icd::Ocl::clFinish;
    dt.clEnqueueNDRangeKernel = Cal::Icd::Ocl::clEnqueueNDRangeKernel;
    dt.clEnqueueTask = Cal::Icd::Ocl::clEnqueueTask;
    dt.clEnqueueMarkerWithWaitList = Cal::Icd::Ocl::clEnqueueMarkerWithWaitList;
    dt.clEnqueueMarker = Cal::Icd::Ocl::clEnqueueMarker;
    dt.clEnqueueBarrierWithWaitList = Cal::Icd::Ocl::clEnqueueBarrierWithWaitList;
    dt.clEnqueueBarrier = Cal::Icd::Ocl::clEnqueueBarrier;
    dt.clEnqueueWaitForEvents = Cal::Icd::Ocl::clEnqueueWaitForEvents;
    dt.clEnqueueMigrateMemObjects = Cal::Icd::Ocl::clEnqueueMigrateMemObjects;
    dt.clGetExtensionFunctionAddressForPlatform = Cal::Icd::Ocl::clGetExtensionFunctionAddressForPlatform;
    dt.clCreateBuffer = Cal::Icd::Ocl::clCreateBuffer;
    dt.clCreateSubBuffer = Cal::Icd::Ocl::clCreateSubBuffer;
    dt.clCreatePipe = Cal::Icd::Ocl::clCreatePipe;
    dt.clGetPipeInfo = Cal::Icd::Ocl::clGetPipeInfo;
    dt.clCreateImage = Cal::Icd::Ocl::clCreateImage;
    dt.clCreateImage2D = Cal::Icd::Ocl::clCreateImage2D;
    dt.clCreateImage3D = Cal::Icd::Ocl::clCreateImage3D;
    dt.clCreateSampler = Cal::Icd::Ocl::clCreateSampler;
    dt.clCreateSamplerWithProperties = Cal::Icd::Ocl::clCreateSamplerWithProperties;
    dt.clCreateImageWithProperties = Cal::Icd::Ocl::clCreateImageWithProperties;
    dt.clCreateBufferWithProperties = Cal::Icd::Ocl::clCreateBufferWithProperties;
    dt.clGetSupportedImageFormats = Cal::Icd::Ocl::clGetSupportedImageFormats;
    dt.clSetKernelArg = Cal::Icd::Ocl::clSetKernelArg;
    dt.clSetProgramSpecializationConstant = Cal::Icd::Ocl::clSetProgramSpecializationConstant;
    dt.clEnqueueWriteBuffer = Cal::Icd::Ocl::clEnqueueWriteBuffer;
    dt.clEnqueueWriteBufferRect = Cal::Icd::Ocl::clEnqueueWriteBufferRect;
    dt.clEnqueueReadBuffer = Cal::Icd::Ocl::clEnqueueReadBuffer;
    dt.clEnqueueReadBufferRect = Cal::Icd::Ocl::clEnqueueReadBufferRect;
    dt.clEnqueueCopyBuffer = Cal::Icd::Ocl::clEnqueueCopyBuffer;
    dt.clEnqueueCopyBufferRect = Cal::Icd::Ocl::clEnqueueCopyBufferRect;
    dt.clEnqueueReadImage = Cal::Icd::Ocl::clEnqueueReadImage;
    dt.clEnqueueWriteImage = Cal::Icd::Ocl::clEnqueueWriteImage;
    dt.clEnqueueCopyImage = Cal::Icd::Ocl::clEnqueueCopyImage;
    dt.clEnqueueCopyImageToBuffer = Cal::Icd::Ocl::clEnqueueCopyImageToBuffer;
    dt.clEnqueueCopyBufferToImage = Cal::Icd::Ocl::clEnqueueCopyBufferToImage;
    dt.clEnqueueMapBuffer = Cal::Icd::Ocl::clEnqueueMapBuffer;
    dt.clEnqueueUnmapMemObject = Cal::Icd::Ocl::clEnqueueUnmapMemObject;
    dt.clEnqueueFillBuffer = Cal::Icd::Ocl::clEnqueueFillBuffer;
    dt.clEnqueueFillImage = Cal::Icd::Ocl::clEnqueueFillImage;
    dt.clWaitForEvents = Cal::Icd::Ocl::clWaitForEvents;
    dt.clGetEventInfo = Cal::Icd::Ocl::clGetEventInfo;
    dt.clGetEventProfilingInfo = Cal::Icd::Ocl::clGetEventProfilingInfo;
    dt.clCreateUserEvent = Cal::Icd::Ocl::clCreateUserEvent;
    dt.clSetUserEventStatus = Cal::Icd::Ocl::clSetUserEventStatus;
    dt.clSetEventCallback = Cal::Icd::Ocl::clSetEventCallback;
    dt.clGetDeviceAndHostTimer = Cal::Icd::Ocl::clGetDeviceAndHostTimer;
    dt.clGetHostTimer = Cal::Icd::Ocl::clGetHostTimer;
    dt.clSVMAlloc = Cal::Icd::Ocl::clSVMAlloc;
    dt.clSVMFree = Cal::Icd::Ocl::clSVMFree;
    dt.clEnqueueSVMMap = Cal::Icd::Ocl::clEnqueueSVMMap;
    dt.clEnqueueSVMUnmap = Cal::Icd::Ocl::clEnqueueSVMUnmap;
    dt.clSetKernelArgSVMPointer = Cal::Icd::Ocl::clSetKernelArgSVMPointer;
    dt.clSetKernelExecInfo = Cal::Icd::Ocl::clSetKernelExecInfo;
    dt.clEnqueueSVMMemFill = Cal::Icd::Ocl::clEnqueueSVMMemFill;
    dt.clEnqueueSVMMigrateMem = Cal::Icd::Ocl::clEnqueueSVMMigrateMem;
    dt.clEnqueueSVMMemcpy = Cal::Icd::Ocl::clEnqueueSVMMemcpy;
    dt.clCreateSubDevicesEXT = Cal::Icd::Ocl::clCreateSubDevicesEXT;
    dt.clReleaseDeviceEXT = Cal::Icd::Ocl::clReleaseDeviceEXT;
    dt.clRetainDeviceEXT = Cal::Icd::Ocl::clRetainDeviceEXT;
    dt.clGetKernelSubGroupInfoKHR = Cal::Icd::Ocl::clGetKernelSubGroupInfoKHR;
    // below are unimplemented, provided bindings are for easier debugging only
    dt.clSetCommandQueueProperty = reinterpret_cast<decltype(dt.clSetCommandQueueProperty)>(Cal::Icd::Ocl::Unimplemented::clSetCommandQueuePropertyUnimpl);
    dt.clCreateFromGLBuffer = reinterpret_cast<decltype(dt.clCreateFromGLBuffer)>(Cal::Icd::Ocl::Unimplemented::clCreateFromGLBufferUnimpl);
    dt.clCreateFromGLTexture2D = reinterpret_cast<decltype(dt.clCreateFromGLTexture2D)>(Cal::Icd::Ocl::Unimplemented::clCreateFromGLTexture2DUnimpl);
    dt.clCreateFromGLTexture3D = reinterpret_cast<decltype(dt.clCreateFromGLTexture3D)>(Cal::Icd::Ocl::Unimplemented::clCreateFromGLTexture3DUnimpl);
    dt.clCreateFromGLRenderbuffer = reinterpret_cast<decltype(dt.clCreateFromGLRenderbuffer)>(Cal::Icd::Ocl::Unimplemented::clCreateFromGLRenderbufferUnimpl);
    dt.clGetGLObjectInfo = reinterpret_cast<decltype(dt.clGetGLObjectInfo)>(Cal::Icd::Ocl::Unimplemented::clGetGLObjectInfoUnimpl);
    dt.clGetGLTextureInfo = reinterpret_cast<decltype(dt.clGetGLTextureInfo)>(Cal::Icd::Ocl::Unimplemented::clGetGLTextureInfoUnimpl);
    dt.clEnqueueAcquireGLObjects = reinterpret_cast<decltype(dt.clEnqueueAcquireGLObjects)>(Cal::Icd::Ocl::Unimplemented::clEnqueueAcquireGLObjectsUnimpl);
    dt.clEnqueueReleaseGLObjects = reinterpret_cast<decltype(dt.clEnqueueReleaseGLObjects)>(Cal::Icd::Ocl::Unimplemented::clEnqueueReleaseGLObjectsUnimpl);
    dt.clGetGLContextInfoKHR = reinterpret_cast<decltype(dt.clGetGLContextInfoKHR)>(Cal::Icd::Ocl::Unimplemented::clGetGLContextInfoKHRUnimpl);
    dt.clCreateEventFromGLsyncKHR = reinterpret_cast<decltype(dt.clCreateEventFromGLsyncKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateEventFromGLsyncKHRUnimpl);
    dt.clCreateFromGLTexture = reinterpret_cast<decltype(dt.clCreateFromGLTexture)>(Cal::Icd::Ocl::Unimplemented::clCreateFromGLTextureUnimpl);
    dt.clCreateFromEGLImageKHR = reinterpret_cast<decltype(dt.clCreateFromEGLImageKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateFromEGLImageKHRUnimpl);
    dt.clEnqueueAcquireEGLObjectsKHR = reinterpret_cast<decltype(dt.clEnqueueAcquireEGLObjectsKHR)>(Cal::Icd::Ocl::Unimplemented::clEnqueueAcquireEGLObjectsKHRUnimpl);
    dt.clEnqueueReleaseEGLObjectsKHR = reinterpret_cast<decltype(dt.clEnqueueReleaseEGLObjectsKHR)>(Cal::Icd::Ocl::Unimplemented::clEnqueueReleaseEGLObjectsKHRUnimpl);
    dt.clCreateEventFromEGLSyncKHR = reinterpret_cast<decltype(dt.clCreateEventFromEGLSyncKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateEventFromEGLSyncKHRUnimpl);
    dt.clGetDeviceIDsFromD3D10KHR = reinterpret_cast<decltype(dt.clGetDeviceIDsFromD3D10KHR)>(Cal::Icd::Ocl::Unimplemented::clGetDeviceIDsFromD3D10KHRUnimpl);
    dt.clCreateFromD3D10BufferKHR = reinterpret_cast<decltype(dt.clCreateFromD3D10BufferKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateFromD3D10BufferKHRUnimpl);
    dt.clCreateFromD3D10Texture2DKHR = reinterpret_cast<decltype(dt.clCreateFromD3D10Texture2DKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateFromD3D10Texture2DKHRUnimpl);
    dt.clCreateFromD3D10Texture3DKHR = reinterpret_cast<decltype(dt.clCreateFromD3D10Texture3DKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateFromD3D10Texture3DKHRUnimpl);
    dt.clEnqueueAcquireD3D10ObjectsKHR = reinterpret_cast<decltype(dt.clEnqueueAcquireD3D10ObjectsKHR)>(Cal::Icd::Ocl::Unimplemented::clEnqueueAcquireD3D10ObjectsKHRUnimpl);
    dt.clEnqueueReleaseD3D10ObjectsKHR = reinterpret_cast<decltype(dt.clEnqueueReleaseD3D10ObjectsKHR)>(Cal::Icd::Ocl::Unimplemented::clEnqueueReleaseD3D10ObjectsKHRUnimpl);
    dt.clGetDeviceIDsFromD3D11KHR = reinterpret_cast<decltype(dt.clGetDeviceIDsFromD3D11KHR)>(Cal::Icd::Ocl::Unimplemented::clGetDeviceIDsFromD3D11KHRUnimpl);
    dt.clCreateFromD3D11BufferKHR = reinterpret_cast<decltype(dt.clCreateFromD3D11BufferKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateFromD3D11BufferKHRUnimpl);
    dt.clCreateFromD3D11Texture2DKHR = reinterpret_cast<decltype(dt.clCreateFromD3D11Texture2DKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateFromD3D11Texture2DKHRUnimpl);
    dt.clCreateFromD3D11Texture3DKHR = reinterpret_cast<decltype(dt.clCreateFromD3D11Texture3DKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateFromD3D11Texture3DKHRUnimpl);
    dt.clCreateFromDX9MediaSurfaceKHR = reinterpret_cast<decltype(dt.clCreateFromDX9MediaSurfaceKHR)>(Cal::Icd::Ocl::Unimplemented::clCreateFromDX9MediaSurfaceKHRUnimpl);
    dt.clEnqueueAcquireD3D11ObjectsKHR = reinterpret_cast<decltype(dt.clEnqueueAcquireD3D11ObjectsKHR)>(Cal::Icd::Ocl::Unimplemented::clEnqueueAcquireD3D11ObjectsKHRUnimpl);
    dt.clEnqueueReleaseD3D11ObjectsKHR = reinterpret_cast<decltype(dt.clEnqueueReleaseD3D11ObjectsKHR)>(Cal::Icd::Ocl::Unimplemented::clEnqueueReleaseD3D11ObjectsKHRUnimpl);
    dt.clGetDeviceIDsFromDX9MediaAdapterKHR = reinterpret_cast<decltype(dt.clGetDeviceIDsFromDX9MediaAdapterKHR)>(Cal::Icd::Ocl::Unimplemented::clGetDeviceIDsFromDX9MediaAdapterKHRUnimpl);
    dt.clEnqueueAcquireDX9MediaSurfacesKHR = reinterpret_cast<decltype(dt.clEnqueueAcquireDX9MediaSurfacesKHR)>(Cal::Icd::Ocl::Unimplemented::clEnqueueAcquireDX9MediaSurfacesKHRUnimpl);
    dt.clEnqueueReleaseDX9MediaSurfacesKHR = reinterpret_cast<decltype(dt.clEnqueueReleaseDX9MediaSurfacesKHR)>(Cal::Icd::Ocl::Unimplemented::clEnqueueReleaseDX9MediaSurfacesKHRUnimpl);
