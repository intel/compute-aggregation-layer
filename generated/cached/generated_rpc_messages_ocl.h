...
struct ClSetContextDestructorCallbackRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ClSetContextDestructorCallbackRpcM() = default;

    ClSetContextDestructorCallbackRpcM(cl_context context, void (CL_CALLBACK* pfn_notify)(cl_context context, void* user_data), void* user_data) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.context = context;
        args.pfn_notify = pfn_notify;
    ...
    static void fillWithoutCapture(ClSetContextDestructorCallbackRpcM &message, cl_context context, void (CL_CALLBACK* pfn_notify)(cl_context context, void* user_data), void* user_data) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.context = context;
        message.args.pfn_notify = pfn_notify;
...
static_assert(std::is_standard_layout_v<ClSetContextDestructorCallbackRpcM>);
struct ClSetMemObjectDestructorCallbackRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ClSetMemObjectDestructorCallbackRpcM() = default;

    ClSetMemObjectDestructorCallbackRpcM(cl_mem memobj, void (CL_CALLBACK* pfn_notify)(cl_mem memobj, void* user_data), void* user_data) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.memobj = memobj;
        args.pfn_notify = pfn_notify;
    ...
    static void fillWithoutCapture(ClSetMemObjectDestructorCallbackRpcM &message, cl_mem memobj, void (CL_CALLBACK* pfn_notify)(cl_mem memobj, void* user_data), void* user_data) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
...
static_assert(std::is_standard_layout_v<ClSetMemObjectDestructorCallbackRpcM>);
...
struct ClSetProgramReleaseCallbackRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ClSetProgramReleaseCallbackRpcM() = default;

    ClSetProgramReleaseCallbackRpcM(cl_program program, void (CL_CALLBACK* pfn_notify)(cl_program program, void* user_data), void* user_data) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.program = program;
        args.pfn_notify = pfn_notify;
    ...
    static void fillWithoutCapture(ClSetProgramReleaseCallbackRpcM &message, cl_program program, void (CL_CALLBACK* pfn_notify)(cl_program program, void* user_data), void* user_data) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.program = program;
        message.args.pfn_notify = pfn_notify;
...
static_assert(std::is_standard_layout_v<ClSetProgramReleaseCallbackRpcM>);
...
static_assert(std::is_standard_layout_v<ClEnqueueMigrateMemObjectsRpcM>);
 ...
 // clCreateBuffer ignored in generator - based on dont_generate_rpc_message flag
...
struct ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmemRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmemRpcM() = default;

    ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmemRpcM(const Captures::DynamicTraits &dynamicTraits, cl_context context, cl_mem_flags flags, size_t size, void* host_ptr, cl_int* errcode_ret) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.context = context;
        args.flags = flags;
    ...
    static void fillWithoutCapture(ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmemRpcM &message, cl_context context, cl_mem_flags flags, size_t size, void* host_ptr, cl_int* errcode_ret) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.context = context;
        message.args.flags = flags;
...
static_assert(std::is_standard_layout_v<ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmemRpcM>);
...
struct ClEnqueueSVMFreeRpcM {
    ...
    struct Args {
        ...
        cl_uint num_svm_pointers = {};
        void** svm_pointers = {};
        void (CL_CALLBACK* pfn_notify)(cl_command_queue queue, cl_uint num_svm_pointers, void ** svm_pointers, void* user_data) = {};
        void* user_data = {};
        cl_uint num_events_in_wait_list = {};
        const cl_event* event_wait_list = {};
        cl_event* event = {};
    ...
    ClEnqueueSVMFreeRpcM() = default;

    ClEnqueueSVMFreeRpcM(const Captures::DynamicTraits &dynamicTraits, cl_command_queue command_queue, cl_uint num_svm_pointers, void** svm_pointers, void (CL_CALLBACK* pfn_notify)(cl_command_queue queue, cl_uint num_svm_pointers, void ** svm_pointers, void* user_data), void* user_data, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.command_queue = command_queue;
        args.num_svm_pointers = num_svm_pointers;
    ...
    static void fillWithoutCapture(ClEnqueueSVMFreeRpcM &message, cl_command_queue command_queue, cl_uint num_svm_pointers, void** svm_pointers, void (CL_CALLBACK* pfn_notify)(cl_command_queue queue, cl_uint num_svm_pointers, void ** svm_pointers, void* user_data), void* user_data, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.command_queue = command_queue;
        message.args.num_svm_pointers = num_svm_pointers;
...
static_assert(std::is_standard_layout_v<ClEnqueueSVMFreeRpcM>);
...
struct ClGetKernelSuggestedLocalWorkSizeKHRRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    struct Args {
        ...
        bool shallowCompareEquals(const Args &rhs) const {
            ...
            equal &= this->global_work_offset == rhs.global_work_offset;
            equal &= this->global_work_size == rhs.global_work_size;
            equal &= this->suggested_local_work_size == rhs.suggested_local_work_size;
            return equal;
        }
    }args;
    ...
    struct Captures {
        ...
        struct DynamicTraits {
            static DynamicTraits calculate(cl_command_queue command_queue, cl_kernel kernel, cl_uint work_dim, const size_t* global_work_offset, const size_t* global_work_size, size_t * suggested_local_work_size);
            uint32_t totalDynamicSize = 0;
            DynamicArgTraits global_work_offset = {};          
            DynamicArgTraits global_work_size = {};          
            DynamicArgTraits suggested_local_work_size = {};          
        };

        cl_int ret = CL_DEVICE_NOT_AVAILABLE;
        uint32_t offsetGlobal_work_size = 0;
        uint32_t offsetSuggested_local_work_size = 0;
        uint32_t countGlobal_work_offset = 0;
        uint32_t countGlobal_work_size = 0;
        uint32_t countSuggested_local_work_size = 0;
        const size_t* getGlobal_work_offset() {
            auto offset = 0;
            return reinterpret_cast<const size_t*>(dynMem + offset);
        }
        ...
        size_t * getSuggested_local_work_size() {
            auto offset = offsetSuggested_local_work_size;
            return reinterpret_cast<size_t *>(dynMem + offset);
        }


        void adjustCaptureLayout(const DynamicTraits &dynamicTraits){
        offsetGlobal_work_size = dynamicTraits.global_work_size.offset;
        offsetSuggested_local_work_size = dynamicTraits.suggested_local_work_size.offset;
        countGlobal_work_offset = dynamicTraits.global_work_offset.count;
        countGlobal_work_size = dynamicTraits.global_work_size.count;
        countSuggested_local_work_size = dynamicTraits.suggested_local_work_size.count;
        }
    ...
    ClGetKernelSuggestedLocalWorkSizeKHRRpcM() = default;

    ClGetKernelSuggestedLocalWorkSizeKHRRpcM(const Captures::DynamicTraits &dynamicTraits, cl_command_queue command_queue, cl_kernel kernel, cl_uint work_dim, const size_t* global_work_offset, const size_t* global_work_size, size_t * suggested_local_work_size) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.command_queue = command_queue;
        args.kernel = kernel;
        ...
        args.global_work_offset = global_work_offset;
        args.global_work_size = global_work_size;
        args.suggested_local_work_size = suggested_local_work_size;
        captures.adjustCaptureLayout(dynamicTraits);
    }
    
    static void fillWithoutCapture(ClGetKernelSuggestedLocalWorkSizeKHRRpcM &message, cl_command_queue command_queue, cl_kernel kernel, cl_uint work_dim, const size_t* global_work_offset, const size_t* global_work_size, size_t * suggested_local_work_size) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.command_queue = command_queue;
        message.args.kernel = kernel;
        ...
        message.args.global_work_offset = global_work_offset;
        message.args.global_work_size = global_work_size;
        message.args.suggested_local_work_size = suggested_local_work_size;
    }
    ...
    void copyToCaller(const Captures::DynamicTraits &dynMemTraits){
        if(args.suggested_local_work_size){
            memcpy(args.suggested_local_work_size, captures.getSuggested_local_work_size(), dynMemTraits.suggested_local_work_size.size);
        }
    }
};
static_assert(std::is_standard_layout_v<ClGetKernelSuggestedLocalWorkSizeKHRRpcM>);
struct ClCreateCommandQueueWithPropertiesKHRRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ClCreateCommandQueueWithPropertiesKHRRpcM() = default;

    ClCreateCommandQueueWithPropertiesKHRRpcM(const Captures::DynamicTraits &dynamicTraits, cl_context context, cl_device_id device, const cl_queue_properties* properties, cl_int* errcode_ret) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.context = context;
        args.device = device;
    ...
    static void fillWithoutCapture(ClCreateCommandQueueWithPropertiesKHRRpcM &message, cl_context context, cl_device_id device, const cl_queue_properties* properties, cl_int* errcode_ret) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.context = context;
        message.args.device = device;
...
static_assert(std::is_standard_layout_v<ClCreateCommandQueueWithPropertiesKHRRpcM>);
...
struct ClEnqueueMemAdviseINTELRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    struct Captures {
        ...
        struct DynamicTraits {
            static DynamicTraits calculate(cl_command_queue command_queue, const void* ptr, size_t size, cl_mem_advice_intel advice, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event);
            uint32_t totalDynamicSize = 0;
            DynamicArgTraits event_wait_list = {};          
        };
    ...
    ClEnqueueMemAdviseINTELRpcM() = default;

    ClEnqueueMemAdviseINTELRpcM(const Captures::DynamicTraits &dynamicTraits, cl_command_queue command_queue, const void* ptr, size_t size, cl_mem_advice_intel advice, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.command_queue = command_queue;
        args.ptr = ptr;
    ...
    static void fillWithoutCapture(ClEnqueueMemAdviseINTELRpcM &message, cl_command_queue command_queue, const void* ptr, size_t size, cl_mem_advice_intel advice, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.command_queue = command_queue;
        message.args.ptr = ptr;
        message.args.size = size;
        message.args.advice = advice;
        message.args.num_events_in_wait_list = num_events_in_wait_list;
        message.args.event_wait_list = event_wait_list;
        message.args.event = event;
    }
...
static_assert(std::is_standard_layout_v<ClEnqueueMemAdviseINTELRpcM>);
...
struct ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_UsmRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_UsmRpcM() = default;

    ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_UsmRpcM(cl_context context, cl_mem_flags flags, size_t size, void* host_ptr, cl_int* errcode_ret) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.context = context;
        args.flags = flags;
    ...
    static void fillWithoutCapture(ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_UsmRpcM &message, cl_context context, cl_mem_flags flags, size_t size, void* host_ptr, cl_int* errcode_ret) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.context = context;
        message.args.flags = flags;
...
static_assert(std::is_standard_layout_v<ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_UsmRpcM>);
struct ClEnqueueWriteBuffer_LocalRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ClEnqueueWriteBuffer_LocalRpcM() = default;

    ClEnqueueWriteBuffer_LocalRpcM(const Captures::DynamicTraits &dynamicTraits, cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void* ptr, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.command_queue = command_queue;
        args.buffer = buffer;
    ...
    static void fillWithoutCapture(ClEnqueueWriteBuffer_LocalRpcM &message, cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void* ptr, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.command_queue = command_queue;
        message.args.buffer = buffer;
...
static_assert(std::is_standard_layout_v<ClEnqueueWriteBuffer_LocalRpcM>);
struct ClEnqueueWriteBuffer_UsmRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ClEnqueueWriteBuffer_UsmRpcM() = default;

    ClEnqueueWriteBuffer_UsmRpcM(const Captures::DynamicTraits &dynamicTraits, cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void* ptr, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.command_queue = command_queue;
        args.buffer = buffer;
    ...
    static void fillWithoutCapture(ClEnqueueWriteBuffer_UsmRpcM &message, cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void* ptr, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.command_queue = command_queue;
        message.args.buffer = buffer;
...
static_assert(std::is_standard_layout_v<ClEnqueueWriteBuffer_UsmRpcM>);
struct ClEnqueueWriteBuffer_SharedRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ClEnqueueWriteBuffer_SharedRpcM() = default;

    ClEnqueueWriteBuffer_SharedRpcM(const Captures::DynamicTraits &dynamicTraits, cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void* ptr, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        header.subtype = messageSubtype;
        args.command_queue = command_queue;
        args.buffer = buffer;
    ...
    static void fillWithoutCapture(ClEnqueueWriteBuffer_SharedRpcM &message, cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t size, const void* ptr, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl;
        message.header.subtype = messageSubtype;
        message.args.command_queue = command_queue;
        message.args.buffer = buffer;
...
static_assert(std::is_standard_layout_v<ClEnqueueWriteBuffer_SharedRpcM>);
struct ClEnqueueWriteBufferRect_LocalRpcM {
    Cal::Rpc::RpcMessageHeader header;
...
static_assert(std::is_standard_layout_v<ClEnqueueWriteBufferRect_LocalRpcM>);
struct ClEnqueueWriteBufferRect_UsmRpcM {
    Cal::Rpc::RpcMessageHeader header;
...
static_assert(std::is_standard_layout_v<ClEnqueueWriteBufferRect_UsmRpcM>);
struct ClEnqueueWriteBufferRect_SharedRpcM {
    Cal::Rpc::RpcMessageHeader header;
...
static_assert(std::is_standard_layout_v<ClEnqueueWriteBufferRect_SharedRpcM>);
...
struct ClEnqueueReadBufferRect_LocalRpcM {
    Cal::Rpc::RpcMessageHeader header;
...
static_assert(std::is_standard_layout_v<ClEnqueueReadBufferRect_LocalRpcM>);
struct ClEnqueueReadBufferRect_UsmRpcM {
    Cal::Rpc::RpcMessageHeader header;
...
static_assert(std::is_standard_layout_v<ClEnqueueReadBufferRect_UsmRpcM>);
struct ClEnqueueReadBufferRect_SharedRpcM {
    Cal::Rpc::RpcMessageHeader header;
...
static_assert(std::is_standard_layout_v<ClEnqueueReadBufferRect_SharedRpcM>);
...
inline const char *getRpcCallFname(const RpcCallId callId) {
    static const std::unordered_map<RpcMessageHeader::MessageUniqueIdT, std::string> options = {
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClSetContextDestructorCallbackRpcM::messageSubtype).id, "clSetContextDestructorCallback"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClSetMemObjectDestructorCallbackRpcM::messageSubtype).id, "clSetMemObjectDestructorCallback"),
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClSetProgramReleaseCallbackRpcM::messageSubtype).id, "clSetProgramReleaseCallback"),
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmemRpcM::messageSubtype).id, "clCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem"),
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueSVMFreeRpcM::messageSubtype).id, "clEnqueueSVMFree"),
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClGetKernelSuggestedLocalWorkSizeKHRRpcM::messageSubtype).id, "clGetKernelSuggestedLocalWorkSizeKHR"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClCreateCommandQueueWithPropertiesKHRRpcM::messageSubtype).id, "clCreateCommandQueueWithPropertiesKHR"),
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueMemAdviseINTELRpcM::messageSubtype).id, "clEnqueueMemAdviseINTEL"),
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_UsmRpcM::messageSubtype).id, "clCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_Usm"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBuffer_LocalRpcM::messageSubtype).id, "clEnqueueWriteBuffer_Local"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBuffer_UsmRpcM::messageSubtype).id, "clEnqueueWriteBuffer_Usm"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBuffer_SharedRpcM::messageSubtype).id, "clEnqueueWriteBuffer_Shared"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBufferRect_LocalRpcM::messageSubtype).id, "clEnqueueWriteBufferRect_Local"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBufferRect_UsmRpcM::messageSubtype).id, "clEnqueueWriteBufferRect_Usm"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBufferRect_SharedRpcM::messageSubtype).id, "clEnqueueWriteBufferRect_Shared"),
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueReadBufferRect_LocalRpcM::messageSubtype).id, "clEnqueueReadBufferRect_Local"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueReadBufferRect_UsmRpcM::messageSubtype).id, "clEnqueueReadBufferRect_Usm"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueReadBufferRect_SharedRpcM::messageSubtype).id, "clEnqueueReadBufferRect_Shared"),
...
inline auto getRpcCallId(const std::string &funcName) {
    ...
    static const std::unordered_map<std::string, RetT> options = {
        ...
        std::pair<std::string, RetT>("clSetContextDestructorCallback", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClSetContextDestructorCallbackRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clSetMemObjectDestructorCallback", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClSetMemObjectDestructorCallbackRpcM::messageSubtype)),
        ...
        std::pair<std::string, RetT>("clSetProgramReleaseCallback", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClSetProgramReleaseCallbackRpcM::messageSubtype)),
        ...
        std::pair<std::string, RetT>("clCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmemRpcM::messageSubtype)),
        ...
        std::pair<std::string, RetT>("clEnqueueSVMFree", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueSVMFreeRpcM::messageSubtype)),
        ...
        std::pair<std::string, RetT>("clGetKernelSuggestedLocalWorkSizeKHR", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClGetKernelSuggestedLocalWorkSizeKHRRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clCreateCommandQueueWithPropertiesKHR", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClCreateCommandQueueWithPropertiesKHRRpcM::messageSubtype)),
        ...
        std::pair<std::string, RetT>("clEnqueueMemAdviseINTEL", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueMemAdviseINTELRpcM::messageSubtype)),
        ...
        std::pair<std::string, RetT>("clCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_Usm", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_UsmRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clEnqueueWriteBuffer_Local", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBuffer_LocalRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clEnqueueWriteBuffer_Usm", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBuffer_UsmRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clEnqueueWriteBuffer_Shared", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBuffer_SharedRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clEnqueueWriteBufferRect_Local", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBufferRect_LocalRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clEnqueueWriteBufferRect_Usm", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBufferRect_UsmRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clEnqueueWriteBufferRect_Shared", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBufferRect_SharedRpcM::messageSubtype)),
        ...
        std::pair<std::string, RetT>("clEnqueueReadBufferRect_Local", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueReadBufferRect_LocalRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clEnqueueReadBufferRect_Usm", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueReadBufferRect_UsmRpcM::messageSubtype)),
        std::pair<std::string, RetT>("clEnqueueReadBufferRect_Shared", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueReadBufferRect_SharedRpcM::messageSubtype)),
...
static constexpr RpcCallId clSetContextDestructorCallback = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClSetContextDestructorCallbackRpcM::messageSubtype};
static constexpr RpcCallId clSetMemObjectDestructorCallback = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClSetMemObjectDestructorCallbackRpcM::messageSubtype};
...
static constexpr RpcCallId clSetProgramReleaseCallback = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClSetProgramReleaseCallbackRpcM::messageSubtype};
...
static constexpr RpcCallId clCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmemRpcM::messageSubtype};
...
static constexpr RpcCallId clEnqueueSVMFree = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueSVMFreeRpcM::messageSubtype};
...
static constexpr RpcCallId clGetKernelSuggestedLocalWorkSizeKHR = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClGetKernelSuggestedLocalWorkSizeKHRRpcM::messageSubtype};
static constexpr RpcCallId clCreateCommandQueueWithPropertiesKHR = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClCreateCommandQueueWithPropertiesKHRRpcM::messageSubtype};
...
static constexpr RpcCallId clEnqueueMemAdviseINTEL = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueMemAdviseINTELRpcM::messageSubtype};
...
static constexpr RpcCallId clCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_Usm = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_UsmRpcM::messageSubtype};
static constexpr RpcCallId clEnqueueWriteBuffer_Local = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBuffer_LocalRpcM::messageSubtype};
static constexpr RpcCallId clEnqueueWriteBuffer_Usm = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBuffer_UsmRpcM::messageSubtype};
static constexpr RpcCallId clEnqueueWriteBuffer_Shared = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBuffer_SharedRpcM::messageSubtype};
static constexpr RpcCallId clEnqueueWriteBufferRect_Local = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBufferRect_LocalRpcM::messageSubtype};
static constexpr RpcCallId clEnqueueWriteBufferRect_Usm = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBufferRect_UsmRpcM::messageSubtype};
static constexpr RpcCallId clEnqueueWriteBufferRect_Shared = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueWriteBufferRect_SharedRpcM::messageSubtype};
...
static constexpr RpcCallId clEnqueueReadBufferRect_Local = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueReadBufferRect_LocalRpcM::messageSubtype};
static constexpr RpcCallId clEnqueueReadBufferRect_Usm = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueReadBufferRect_UsmRpcM::messageSubtype};
static constexpr RpcCallId clEnqueueReadBufferRect_Shared = {Cal::Rpc::RpcMessageHeader::messageTypeRpcOcl, ClEnqueueReadBufferRect_SharedRpcM::messageSubtype};
...
using clSetContextDestructorCallback = ClSetContextDestructorCallbackRpcM;
using clSetMemObjectDestructorCallback = ClSetMemObjectDestructorCallbackRpcM;
...
using clSetProgramReleaseCallback = ClSetProgramReleaseCallbackRpcM;
...
using clCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem = ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmemRpcM;
...
using clEnqueueSVMFree = ClEnqueueSVMFreeRpcM;
...
using clGetKernelSuggestedLocalWorkSizeKHR = ClGetKernelSuggestedLocalWorkSizeKHRRpcM;
using clCreateCommandQueueWithPropertiesKHR = ClCreateCommandQueueWithPropertiesKHRRpcM;
...
using clEnqueueMemAdviseINTEL = ClEnqueueMemAdviseINTELRpcM;
using clGetDeviceGlobalVariablePointerINTEL = ClGetDeviceGlobalVariablePointerINTELRpcM;
using clCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_Usm = ClCreateBufferRpcHelperNotUseHostPtrZeroCopyMallocShmem_UsmRpcM;
using clEnqueueWriteBuffer_Local = ClEnqueueWriteBuffer_LocalRpcM;
using clEnqueueWriteBuffer_Usm = ClEnqueueWriteBuffer_UsmRpcM;
using clEnqueueWriteBuffer_Shared = ClEnqueueWriteBuffer_SharedRpcM;
using clEnqueueWriteBufferRect_Local = ClEnqueueWriteBufferRect_LocalRpcM;
using clEnqueueWriteBufferRect_Usm = ClEnqueueWriteBufferRect_UsmRpcM;
using clEnqueueWriteBufferRect_Shared = ClEnqueueWriteBufferRect_SharedRpcM;
...
using clEnqueueReadBufferRect_Local = ClEnqueueReadBufferRect_LocalRpcM;
using clEnqueueReadBufferRect_Usm = ClEnqueueReadBufferRect_UsmRpcM;
using clEnqueueReadBufferRect_Shared = ClEnqueueReadBufferRect_SharedRpcM;
