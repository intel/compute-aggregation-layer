...
struct ZesDeviceGetRpcM {
    ...
    struct Captures {
        ...
        struct DynamicTraits {
            static DynamicTraits calculate(zes_driver_handle_t hDriver, uint32_t* pCount, zes_device_handle_t* phDevices);
    ...
    ZesDeviceGetRpcM() = default;

    ZesDeviceGetRpcM(const Captures::DynamicTraits &dynamicTraits, zes_driver_handle_t hDriver, uint32_t* pCount, zes_device_handle_t* phDevices) {
    ...
    static void fillWithoutCapture(ZesDeviceGetRpcM &message, zes_driver_handle_t hDriver, uint32_t* pCount, zes_device_handle_t* phDevices) {
...
static_assert(std::is_standard_layout_v<ZesDeviceGetRpcM>);
...
struct ZeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronousRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ZeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronousRpcM() = default;

    ZeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronousRpcM(const Captures::DynamicTraits &dynamicTraits, ze_command_list_handle_t hCommandList, void* dstptr, const void* srcptr, size_t size, ze_event_handle_t hSignalEvent, uint32_t numWaitEvents, ze_event_handle_t* phWaitEvents) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero;
        header.subtype = messageSubtype;
        args.hCommandList = hCommandList;
        args.dstptr = dstptr;
    ...
    static void fillWithoutCapture(ZeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronousRpcM &message, ze_command_list_handle_t hCommandList, void* dstptr, const void* srcptr, size_t size, ze_event_handle_t hSignalEvent, uint32_t numWaitEvents, ze_event_handle_t* phWaitEvents) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero;
        message.header.subtype = messageSubtype;
        message.args.hCommandList = hCommandList;
        message.args.dstptr = dstptr;
...
static_assert(std::is_standard_layout_v<ZeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronousRpcM>);
struct ZeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronousRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ZeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronousRpcM() = default;

    ZeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronousRpcM(const Captures::DynamicTraits &dynamicTraits, ze_command_list_handle_t hCommandList, void* dstptr, const void* srcptr, size_t size, ze_event_handle_t hSignalEvent, uint32_t numWaitEvents, ze_event_handle_t* phWaitEvents) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero;
        header.subtype = messageSubtype;
        args.hCommandList = hCommandList;
        args.dstptr = dstptr;
    ...
    static void fillWithoutCapture(ZeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronousRpcM &message, ze_command_list_handle_t hCommandList, void* dstptr, const void* srcptr, size_t size, ze_event_handle_t hSignalEvent, uint32_t numWaitEvents, ze_event_handle_t* phWaitEvents) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero;
        message.header.subtype = messageSubtype;
        message.args.hCommandList = hCommandList;
        message.args.dstptr = dstptr;
...
static_assert(std::is_standard_layout_v<ZeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronousRpcM>);
            ...
            if(descNestedTraitsCount > 0){
                ...
                for (uint32_t i = 0; i < descNestedTraitsCount; ++i) {
                    ...
                    for(int32_t j = 1; j <= descTraits[i].pNextCount; ++j){
                        ...
                        const auto extensionType = descPNextListElementTraits[j - 1].extensionType;
...
inline const char *getRpcCallFname(const RpcCallId callId) {
    static const std::unordered_map<RpcMessageHeader::MessageUniqueIdT, std::string> options = {
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZesDeviceGetRpcM::messageSubtype).id, "zesDeviceGet"),
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronousRpcM::messageSubtype).id, "zeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronous"),
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronousRpcM::messageSubtype).id, "zeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronous"),
...
inline auto getRpcCallId(const std::string &funcName) {
    ...
    static const std::unordered_map<std::string, RetT> options = {
        std::pair<std::string, RetT>("zesDeviceGet", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZesDeviceGetRpcM::messageSubtype)),
        ...
        std::pair<std::string, RetT>("zeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronous", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronousRpcM::messageSubtype)),
        std::pair<std::string, RetT>("zeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronous", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronousRpcM::messageSubtype)),
...
static constexpr RpcCallId zesDeviceGet = {Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZesDeviceGetRpcM::messageSubtype};
...
static constexpr RpcCallId zeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronous = {Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronousRpcM::messageSubtype};
static constexpr RpcCallId zeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronous = {Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronousRpcM::messageSubtype};
...
using zesDeviceGet = ZesDeviceGetRpcM;
...
using zeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronous = ZeCommandListAppendMemoryCopyRpcHelperMalloc2MallocImmediateAsynchronousRpcM;
using zeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronous = ZeCommandListAppendMemoryCopyRpcHelperUsm2MallocImmediateAsynchronousRpcM;
