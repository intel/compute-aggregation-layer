...
struct ZeCommandListAppendMemAdviseRpcM {
    Cal::Rpc::RpcMessageHeader header;
    ...
    ZeCommandListAppendMemAdviseRpcM() = default;

    ZeCommandListAppendMemAdviseRpcM(ze_command_list_handle_t hCommandList, ze_device_handle_t hDevice, const void* ptr, size_t size, ze_memory_advice_t advice) {
        header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero;
        header.subtype = messageSubtype;
        args.hCommandList = hCommandList;
        args.hDevice = hDevice;
    ...
    static void fillWithoutCapture(ZeCommandListAppendMemAdviseRpcM &message, ze_command_list_handle_t hCommandList, ze_device_handle_t hDevice, const void* ptr, size_t size, ze_memory_advice_t advice) {
        message.header.type = Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero;
        message.header.subtype = messageSubtype;
        message.args.hCommandList = hCommandList;
        message.args.hDevice = hDevice;
...
static_assert(std::is_standard_layout_v<ZeCommandListAppendMemAdviseRpcM>);
...
inline const char *getRpcCallFname(const RpcCallId callId) {
    static const std::unordered_map<RpcMessageHeader::MessageUniqueIdT, std::string> options = {
        ...
        std::pair<RpcMessageHeader::MessageUniqueIdT, std::string>(RpcCallId(Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZeCommandListAppendMemAdviseRpcM::messageSubtype).id, "zeCommandListAppendMemAdvise"),
...
inline auto getRpcCallId(const std::string &funcName) {
    ...
    static const std::unordered_map<std::string, RetT> options = {
        ...
        std::pair<std::string, RetT>("zeCommandListAppendMemAdvise", RetT(Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZeCommandListAppendMemAdviseRpcM::messageSubtype)),
...
static constexpr RpcCallId zeCommandListAppendMemAdvise = {Cal::Rpc::RpcMessageHeader::messageTypeRpcLevelZero, ZeCommandListAppendMemAdviseRpcM::messageSubtype};
...
using zeCommandListAppendMemAdvise = ZeCommandListAppendMemAdviseRpcM;
